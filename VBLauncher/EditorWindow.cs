...
private readonly string[] _ammoTypes = ["None", "15mm EC", ".223", ".22/.22 Injector", "Empty", "2mm EC", ".30", "40mm", ".44", ".45", ".50", "7.62mm", "9mm", "BB", "Microfusion Cell", "Naphate", "Heavy Rivet", "Lil' Rivet", "Rocket", "Small Energy Cell"];
