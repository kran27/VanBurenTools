...
Partial Class Editor
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As ComponentResourceManager = New ComponentResourceManager(GetType(Editor))
        ...
        MainMenuStrip = New DarkMenuStrip()
        ...
        CType(Triggernud, ISupportInitialize).BeginInit()
        EPTHGB.SuspendLayout()
        CType(EPTHnud, ISupportInitialize).BeginInit()
        EMSDgb.SuspendLayout()
        EME2gb.SuspendLayout()
        CType(EME2dgv, ISupportInitialize).BeginInit()
        EMEFgb.SuspendLayout()
        ECAMgb.SuspendLayout()
        EMAPgb.SuspendLayout()
        EMEPgb.SuspendLayout()
        CType(EMEPnud, ISupportInitialize).BeginInit()
        MainMenuStrip.SuspendLayout()
        CType(GWAMsf, ISupportInitialize).BeginInit()
        CType(EEN2dgv, ISupportInitialize).BeginInit()
        CRTgb.SuspendLayout()
        GCHRgb.SuspendLayout()
        GCREgb.SuspendLayout()
        GCREtlp.SuspendLayout()
        CType(GCREdgv, ISupportInitialize).BeginInit()
        CType(GCREskv, ISupportInitialize).BeginInit()
        CType(GCREspv, ISupportInitialize).BeginInit()
        CType(GCREage, ISupportInitialize).BeginInit()
        GWAMgb.SuspendLayout()
        GWAMtlp.SuspendLayout()
        CType(GWAMani, ISupportInitialize).BeginInit()
        CType(GWAMap, ISupportInitialize).BeginInit()
        CType(GWAMr, ISupportInitialize).BeginInit()
        CType(GWAMmin, ISupportInitialize).BeginInit()
        CType(GWAMmax, ISupportInitialize).BeginInit()
        CType(GWAManSR, ISupportInitialize).BeginInit()
        GENTgb.SuspendLayout()
        CType(GENTihp, ISupportInitialize).BeginInit()
        CType(GENTmhp, ISupportInitialize).BeginInit()
        CType(GENTuSR, ISupportInitialize).BeginInit()
        CType(GENTnSR, ISupportInitialize).BeginInit()
        CType(GENTlSR, ISupportInitialize).BeginInit()
        CType(GENThSR, ISupportInitialize).BeginInit()
        ...
        ' EMAPs3
        ' 
        EMAPs3.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EMAPs3.BorderStyle = BorderStyle.FixedSingle
        EMAPs3.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EMAPs2
        ' 
        EMAPs2.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EMAPs2.BorderStyle = BorderStyle.FixedSingle
        EMAPs2.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EMAPs1
        ' 
        EMAPs1.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EMAPs1.BorderStyle = BorderStyle.FixedSingle
        EMAPs1.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' _2MWTlmy
        ' 
        _2MWTlmy.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        _2MWTlmy.BorderStyle = BorderStyle.FixedSingle
        _2MWTlmy.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' _2MWTlmx
        ' 
        _2MWTlmx.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        _2MWTlmx.BorderStyle = BorderStyle.FixedSingle
        _2MWTlmx.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' _2MWTtex
        ' 
        _2MWTtex.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        _2MWTtex.BorderStyle = BorderStyle.FixedSingle
        _2MWTtex.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' _2MWTmpf
        ' 
        _2MWTmpf.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        _2MWTmpf.BorderStyle = BorderStyle.FixedSingle
        _2MWTmpf.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' _2MWTz
        ' 
        _2MWTz.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        _2MWTz.BorderStyle = BorderStyle.FixedSingle
        _2MWTz.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' _2MWTy
        ' 
        _2MWTy.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        _2MWTy.BorderStyle = BorderStyle.FixedSingle
        _2MWTy.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' _2MWTx
        ' 
        _2MWTx.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        _2MWTx.BorderStyle = BorderStyle.FixedSingle
        _2MWTx.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        Triggernud.Maximum = New [Decimal](New Integer() {99, 0, 0, 0})
        ...
        ' Triggern
        ' 
        Triggern.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        Triggern.BorderStyle = BorderStyle.FixedSingle
        Triggern.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' Triggerx
        ' 
        Triggerx.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        Triggerx.BorderStyle = BorderStyle.FixedSingle
        Triggerx.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' Triggery
        ' 
        Triggery.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        Triggery.BorderStyle = BorderStyle.FixedSingle
        Triggery.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' Triggerz
        ' 
        Triggerz.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        Triggerz.BorderStyle = BorderStyle.FixedSingle
        Triggerz.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EPTHr
        ' 
        EPTHr.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EPTHr.BorderStyle = BorderStyle.FixedSingle
        EPTHr.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EPTHn
        ' 
        EPTHn.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EPTHn.BorderStyle = BorderStyle.FixedSingle
        EPTHn.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EPTHx
        ' 
        EPTHx.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EPTHx.BorderStyle = BorderStyle.FixedSingle
        EPTHx.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EPTHy
        ' 
        EPTHy.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EPTHy.BorderStyle = BorderStyle.FixedSingle
        EPTHy.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EPTHz
        ' 
        EPTHz.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EPTHz.BorderStyle = BorderStyle.FixedSingle
        EPTHz.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EMSDs1
        ' 
        EMSDs1.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EMSDs1.BorderStyle = BorderStyle.FixedSingle
        EMSDs1.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EMSDs2
        ' 
        EMSDs2.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EMSDs2.BorderStyle = BorderStyle.FixedSingle
        EMSDs2.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EMSDz
        ' 
        EMSDz.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EMSDz.BorderStyle = BorderStyle.FixedSingle
        EMSDz.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EMSDy
        ' 
        EMSDy.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EMSDy.BorderStyle = BorderStyle.FixedSingle
        EMSDy.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EMSDx
        ' 
        EMSDx.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EMSDx.BorderStyle = BorderStyle.FixedSingle
        EMSDx.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EME2r
        ' 
        EME2r.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EME2r.BorderStyle = BorderStyle.FixedSingle
        EME2r.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EME2z
        ' 
        EME2z.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EME2z.BorderStyle = BorderStyle.FixedSingle
        EME2z.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EME2y
        ' 
        EME2y.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EME2y.BorderStyle = BorderStyle.FixedSingle
        EME2y.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EME2s5
        ' 
        EME2s5.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EME2s5.BorderStyle = BorderStyle.FixedSingle
        EME2s5.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EME2s4
        ' 
        EME2s4.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EME2s4.BorderStyle = BorderStyle.FixedSingle
        EME2s4.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EME2x
        ' 
        EME2x.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EME2x.BorderStyle = BorderStyle.FixedSingle
        EME2x.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        EME2dgv.BackgroundColor = Color.FromArgb(CByte(16), CByte(16), CByte(16))
        ...
        ' EME2s3
        ' 
        EME2s3.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EME2s3.BorderStyle = BorderStyle.FixedSingle
        EME2s3.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EME2s2
        ' 
        EME2s2.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EME2s2.BorderStyle = BorderStyle.FixedSingle
        EME2s2.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EME2s1
        ' 
        EME2s1.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EME2s1.BorderStyle = BorderStyle.FixedSingle
        EME2s1.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EME2n
        ' 
        EME2n.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EME2n.BorderStyle = BorderStyle.FixedSingle
        EME2n.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EMEFr
        ' 
        EMEFr.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EMEFr.BorderStyle = BorderStyle.FixedSingle
        EMEFr.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EMEFs1
        ' 
        EMEFs1.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EMEFs1.BorderStyle = BorderStyle.FixedSingle
        EMEFs1.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EMEFs2
        ' 
        EMEFs2.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EMEFs2.BorderStyle = BorderStyle.FixedSingle
        EMEFs2.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EMEFz
        ' 
        EMEFz.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EMEFz.BorderStyle = BorderStyle.FixedSingle
        EMEFz.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EMEFy
        ' 
        EMEFy.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EMEFy.BorderStyle = BorderStyle.FixedSingle
        EMEFy.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EMEFx
        ' 
        EMEFx.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EMEFx.BorderStyle = BorderStyle.FixedSingle
        EMEFx.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' ECAMr
        ' 
        ECAMr.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        ECAMr.BorderStyle = BorderStyle.FixedSingle
        ECAMr.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' ECAMz
        ' 
        ECAMz.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        ECAMz.BorderStyle = BorderStyle.FixedSingle
        ECAMz.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' ECAMy
        ' 
        ECAMy.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        ECAMy.BorderStyle = BorderStyle.FixedSingle
        ECAMy.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' ECAMx
        ' 
        ECAMx.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        ECAMx.BorderStyle = BorderStyle.FixedSingle
        ECAMx.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EMEPr
        ' 
        EMEPr.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EMEPr.BorderStyle = BorderStyle.FixedSingle
        EMEPr.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EMEPz
        ' 
        EMEPz.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EMEPz.BorderStyle = BorderStyle.FixedSingle
        EMEPz.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EMEPy
        ' 
        EMEPy.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EMEPy.BorderStyle = BorderStyle.FixedSingle
        EMEPy.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EMEPx
        ' 
        EMEPx.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EMEPx.BorderStyle = BorderStyle.FixedSingle
        EMEPx.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' MainMenuStrip
        ' 
        MainMenuStrip.BackColor = Color.FromArgb(CByte(31), CByte(31), CByte(32))
        MainMenuStrip.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        MainMenuStrip.Items.AddRange(New ToolStripItem() {FileToolStripMenuItem, OptionsToolStripMenuItem, ToolsToolStripMenuItem})
        MainMenuStrip.Location = New Point(0, 0)
        MainMenuStrip.Name = "MainMenuStrip"
        MainMenuStrip.Padding = New Padding(3, 2, 0, 2)
        MainMenuStrip.Size = New Size(1924, 24)
        ...
        ' 
        NewToolStripMenuItem.BackColor = Color.FromArgb(CByte(31), CByte(31), CByte(32))
        ...
        NewToolStripMenuItem.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        NewToolStripMenuItem.Name = "NewToolStripMenuItem"
        NewToolStripMenuItem.Size = New Size(146, 22)
        NewToolStripMenuItem.Text = "New"' 
        ' AmoToolStripMenuItem
        ' 
        AmoToolStripMenuItem.BackColor = Color.FromArgb(CByte(31), CByte(31), CByte(32))
        AmoToolStripMenuItem.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' 
        ArmToolStripMenuItem.BackColor = Color.FromArgb(CByte(31), CByte(31), CByte(32))
        ArmToolStripMenuItem.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' 
        ConToolStripMenuItem.BackColor = Color.FromArgb(CByte(31), CByte(31), CByte(32))
        ConToolStripMenuItem.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' 
        CrtToolStripMenuItem.BackColor = Color.FromArgb(CByte(31), CByte(31), CByte(32))
        CrtToolStripMenuItem.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' 
        DorToolStripMenuItem.BackColor = Color.FromArgb(CByte(31), CByte(31), CByte(32))
        DorToolStripMenuItem.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' 
        IntToolStripMenuItem.BackColor = Color.FromArgb(CByte(31), CByte(31), CByte(32))
        IntToolStripMenuItem.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' 
        ItmToolStripMenuItem.BackColor = Color.FromArgb(CByte(31), CByte(31), CByte(32))
        ItmToolStripMenuItem.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ItmToolStripMenuItem.Name = "ItmToolStripMenuItem"
        ItmToolStripMenuItem.Size = New Size(101, 22)
        ItmToolStripMenuItem.Text = ".itm"' 
        ' MapToolStripMenuItem
        ' 
        MapToolStripMenuItem.BackColor = Color.FromArgb(CByte(31), CByte(31), CByte(32))
        MapToolStripMenuItem.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' 
        UseToolStripMenuItem.BackColor = Color.FromArgb(CByte(31), CByte(31), CByte(32))
        UseToolStripMenuItem.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' 
        WeaToolStripMenuItem.BackColor = Color.FromArgb(CByte(31), CByte(31), CByte(32))
        WeaToolStripMenuItem.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        WeaToolStripMenuItem.Name = "WeaToolStripMenuItem"
        WeaToolStripMenuItem.Size = New Size(101, 22)
        WeaToolStripMenuItem.Text = ".wea"' 
        ' OpenToolStripMenuItem
        ' 
        OpenToolStripMenuItem.BackColor = Color.FromArgb(CByte(31), CByte(31), CByte(32))
        OpenToolStripMenuItem.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' 
        SaveToolStripMenuItem.BackColor = Color.FromArgb(CByte(31), CByte(31), CByte(32))
        SaveToolStripMenuItem.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' 
        SetEnglishstfLocationToolStripMenuItem.BackColor = Color.FromArgb(CByte(31), CByte(31), CByte(32))
        SetEnglishstfLocationToolStripMenuItem.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EnableSTFEdit
        ' 
        EnableSTFEdit.BackColor = Color.FromArgb(CByte(16), CByte(16), CByte(17))
        EnableSTFEdit.CheckOnClick = True
        EnableSTFEdit.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' 
        StfToolStripMenuItem.BackColor = Color.FromArgb(CByte(31), CByte(31), CByte(32))
        StfToolStripMenuItem.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        StfToolStripMenuItem.Name = "StfToolStripMenuItem"
        StfToolStripMenuItem.Size = New Size(124, 22)
        StfToolStripMenuItem.Text = ".stf to .txt"' 
        ' TxtTostfToolStripMenuItem
        ' 
        TxtTostfToolStripMenuItem.BackColor = Color.FromArgb(CByte(31), CByte(31), CByte(32))
        TxtTostfToolStripMenuItem.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        TxtTostfToolStripMenuItem.Name = "TxtTostfToolStripMenuItem"
        TxtTostfToolStripMenuItem.Size = New Size(124, 22)
        ...
        GWAMsf.Maximum = New [Decimal](New Integer() {9999, 0, 0, 0})
        GWAMsf.Name = "GWAMsf"
        ...
        EEN2dgv.BackgroundColor = Color.FromArgb(CByte(16), CByte(16), CByte(16))
        ...
        ' GCHRn
        ' 
        GCHRn.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        GCHRn.BorderStyle = BorderStyle.FixedSingle
        GCHRn.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' GCREdsb
        ' 
        GCREdsb.Anchor = AnchorStyles.Bottom Or AnchorStyles.Right
        ...
        GCREdgv.BackgroundColor = Color.FromArgb(CByte(16), CByte(16), CByte(16))
        ...
        GCREskv.Maximum = New [Decimal](New Integer() {255, 0, 0, 0})
        ...
        GCREspv.Maximum = New [Decimal](New Integer() {255, 0, 0, 0})
        ...
        ' GCREp
        ' 
        GCREp.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        GCREp.BorderStyle = BorderStyle.FixedSingle
        GCREtlp.SetColumnSpan(GCREp, 2)
        GCREp.Dock = DockStyle.Fill
        GCREp.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' GCREsocm
        ' 
        GCREsocm.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        GCREsocm.BorderStyle = BorderStyle.FixedSingle
        GCREsocm.Dock = DockStyle.Fill
        GCREsocm.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' GCREsoct
        ' 
        GCREsoct.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        GCREsoct.BorderStyle = BorderStyle.FixedSingle
        GCREsoct.Dock = DockStyle.Fill
        GCREsoct.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        GWAMani.Maximum = New [Decimal](New Integer() {9999, 0, 0, 0})
        ...
        GWAMap.Maximum = New [Decimal](New Integer() {9999, 0, 0, 0})
        GWAMap.Name = "GWAMap"
        ...
        GWAMr.Maximum = New [Decimal](New Integer() {9999, 0, 0, 0})
        GWAMr.Name = "GWAMr"
        ...
        GWAMmin.Maximum = New [Decimal](New Integer() {9999, 0, 0, 0})
        ...
        GWAMmax.Maximum = New [Decimal](New Integer() {9999, 0, 0, 0})
        ...
        GWAManSR.Maximum = New [Decimal](New Integer() {9999, 0, 0, 0})
        ...
        ' GWAMef
        ' 
        GWAMef.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        GWAMef.BorderStyle = BorderStyle.FixedSingle
        GWAMtlp.SetColumnSpan(GWAMef, 3)
        GWAMef.Dock = DockStyle.Fill
        GWAMef.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' GWAMan
        ' 
        GWAMan.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        GWAMan.BorderStyle = BorderStyle.FixedSingle
        GWAMtlp.SetColumnSpan(GWAMan, 3)
        GWAMan.Dock = DockStyle.Fill
        GWAMan.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' GENTu
        ' 
        GENTu.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        GENTu.BorderStyle = BorderStyle.FixedSingle
        GENTu.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' GENTn
        ' 
        GENTn.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        GENTn.BorderStyle = BorderStyle.FixedSingle
        GENTn.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' GENTl
        ' 
        GENTl.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        GENTl.BorderStyle = BorderStyle.FixedSingle
        GENTl.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' GENTh
        ' 
        GENTh.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        GENTh.BorderStyle = BorderStyle.FixedSingle
        GENTh.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        GENTihp.Maximum = New [Decimal](New Integer() {Integer.MaxValue, 0, 0, 0})
        ...
        GENTmhp.Maximum = New [Decimal](New Integer() {Integer.MaxValue, 0, 0, 0})
        ...
        GENTuSR.Maximum = New [Decimal](New Integer() {9999, 0, 0, 0})
        ...
        GENTnSR.Maximum = New [Decimal](New Integer() {9999, 0, 0, 0})
        ...
        GENTlSR.Maximum = New [Decimal](New Integer() {9999, 0, 0, 0})
        ...
        GENThSR.Maximum = New [Decimal](New Integer() {9999, 0, 0, 0})
        ...
        ' EEN2s5
        ' 
        EEN2s5.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EEN2s5.BorderStyle = BorderStyle.FixedSingle
        EEN2s5.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EEN2s4
        ' 
        EEN2s4.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EEN2s4.BorderStyle = BorderStyle.FixedSingle
        EEN2s4.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EEN2s3
        ' 
        EEN2s3.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EEN2s3.BorderStyle = BorderStyle.FixedSingle
        EEN2s3.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EEN2s2
        ' 
        EEN2s2.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EEN2s2.BorderStyle = BorderStyle.FixedSingle
        EEN2s2.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EEN2s1
        ' 
        EEN2s1.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EEN2s1.BorderStyle = BorderStyle.FixedSingle
        EEN2s1.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EEN2actt
        ' 
        EEN2actt.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EEN2actt.BorderStyle = BorderStyle.FixedSingle
        EEN2actt.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EEN2invt
        ' 
        EEN2invt.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EEN2invt.BorderStyle = BorderStyle.FixedSingle
        EEN2invt.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' EEN2skl
        ' 
        EEN2skl.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        EEN2skl.BorderStyle = BorderStyle.FixedSingle
        EEN2skl.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' GITMrl
        ' 
        GITMrl.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        GITMrl.BorderStyle = BorderStyle.FixedSingle
        GITMrl.Dock = DockStyle.Fill
        GITMrl.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' GITMsoct
        ' 
        GITMsoct.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        GITMsoct.BorderStyle = BorderStyle.FixedSingle
        TableLayoutPanel1.SetColumnSpan(GITMsoct, 2)
        GITMsoct.Dock = DockStyle.Fill
        GITMsoct.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        ' GITMsocm
        ' 
        GITMsocm.BackColor = Color.FromArgb(CByte(26), CByte(26), CByte(28))
        GITMsocm.BorderStyle = BorderStyle.FixedSingle
        TableLayoutPanel1.SetColumnSpan(GITMsocm, 2)
        GITMsocm.Dock = DockStyle.Fill
        GITMsocm.ForeColor = Color.FromArgb(CByte(213), CByte(213), CByte(213))
        ...
        TransparencyKey = Color.FromArgb(CByte(31), CByte(31), CByte(32))
        ...
        CType(EMEPnud, ISupportInitialize).EndInit()
        MainMenuStrip.ResumeLayout(False)
        MainMenuStrip.PerformLayout()
        CType(GWAMsf, ISupportInitialize).EndInit()
        CType(EEN2dgv, ISupportInitialize).EndInit()
        ...
        CType(GCREdgv, ISupportInitialize).EndInit()
        CType(GCREskv, ISupportInitialize).EndInit()
        CType(GCREspv, ISupportInitialize).EndInit()
        CType(GCREage, ISupportInitialize).EndInit()
        GWAMgb.ResumeLayout(False)
        GWAMtlp.ResumeLayout(False)
        GWAMtlp.PerformLayout()
        CType(GWAMani, ISupportInitialize).EndInit()
        CType(GWAMap, ISupportInitialize).EndInit()
        CType(GWAMr, ISupportInitialize).EndInit()
        CType(GWAMmin, ISupportInitialize).EndInit()
        CType(GWAMmax, ISupportInitialize).EndInit()
        CType(GWAManSR, ISupportInitialize).EndInit()
        GENTgb.ResumeLayout(False)
        GENTgb.PerformLayout()
        CType(GENTihp, ISupportInitialize).EndInit()
        CType(GENTmhp, ISupportInitialize).EndInit()
        CType(GENTuSR, ISupportInitialize).EndInit()
        CType(GENTnSR, ISupportInitialize).EndInit()
        CType(GENTlSR, ISupportInitialize).EndInit()
        CType(GENThSR, ISupportInitialize).EndInit()
